export const data = {
  profile: {
    nameJP: "城戸 双汰朗",
    nameEN: "kido sotaro",
    portrait: "./img/01_about/kidosotaro.webp",
    title: "情報科学芸術大学院大学 修士2年",
    bio: [
      "2001年、熊本県生まれ。",
      "熊本県立大学卒、情報科学芸術大学院大学（IAMAS）在籍(休学中)。",
      "在籍していた研究室での活動を通して「人とテクノロジーの関係性」に興味を持ち、現在は「デジタル社会における身体性」をテーマの中心に研究に取り組んでいます。"
    ]
  },
  ...
  workExperience: [
    {
      period: "2024/04 - 現在",
      title: "情報科学芸術大学院大学　メディア表現研究科",
      desc: "「目を使って映像の中のオブジェクトを操作する装置」を使ったワークショップが活動の中心に。"
    },
    {
      period: "2020/04 - 2024/03",
      title: "熊本県立大学　総合管理学部 総合管理学科",
      desc:
        `[公共] [ビジネス] [情報] 領域を体系的に学びつつ、ゼミ選択を期に情報コースを専攻。<a href="https://www.pu-kumamoto.ac.jp/users_site/kishibashi/lab/" target="_blank" rel="noopener">石橋研究室🔗</a>に在籍。<br>“人とコンピュータとの相互作用”をテーマに研究に取り組む。卒業時、高校教員免許（情報）を取得。`
    },
    {
      period: "2017/04 - 2020/03",
      title: "熊本中央高等学校　普通科",
      desc:
        "地元を離れ、県内有数のバドミントン部強豪校に進学を決意。3年間、寮生活を送る。<br>令和元年度高校総体にて団体戦レギュラー入り、県内3位入賞を果たす。"
    }
  ],
  ...
  awards: [
    { date: "2024.10", contest: "Interverse Virtual Reality Challenge (IVRC) 2024", prize: "[青沼優介賞]" },
    { date: "2024.9", contest: "Interverse Virtual Reality Challenge (IVRC) 2024", prize: "[REAPSTAGE 進出/ヤマハ株式会社賞/CRI・ミドルウェア賞]" },
    { date: "2023.3", contest: "映像表現・芸術科学フォーラム2023", prize: "[優秀発表賞（口頭発表）]" },
    { date: "2019.6", contest: "熊本県高校総体2019 バドミントン競技", prize: "[団体戦 3位入賞]" }
  ],
