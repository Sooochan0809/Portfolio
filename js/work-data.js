    ...
    window.works = [
        {
            ...
            body: [
                ...
                sec("概要",
                    p("《みる目／みせる目／みられる目》は、「目」の普段、見過ごされがちな側面に焦点を当を当てたワークショップ。"),
        ...
        },
        {
            ...
            body: [
                ...
                sec("概要",
                    p("2025年5月5日、スイトピアで開催された「スイトピアテラス」にて、《め遊び ― 目でモノに触ったり、気持ちを伝えたり、いろいろな目の使い方にチャレンジしよう！》を実施。 当日は、老若男女さまざまな方々に《め触り》を体験して頂いた。"),
                ),
                sec("《め触り》について",
