    ...
    window.works = [
        {
            ...
            body: [
                ...
                sec("概要",
                    p("2025年6月28日、あいちワークショップギャザリングにて、《みる目／みせる目／みられる目》を実施。本ワークショップは、「目」の普段、見過ごされがちな側面に焦点を当てたワークショップ。"),
                    p("オリジナルのiOSアプリケーションを用い、アプリケーション中のゲームを遊びながら進行していく。"),
                ),
                sec("問い / 問題意識",
                    ...
                    p("　・見られる目：「見せる目」と対になる側面で、他者の視点から自分の目がどのように受け取られているか、客観的に意識する側面"),
                    p("　　　"),
