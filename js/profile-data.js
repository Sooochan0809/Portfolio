export const data = {
  profile: {
    ...
    bio: [
      ...
      "学部生時代の研究を通して「人とテクノロジーの関係性」に興味を持ち、現在は「デジタル社会における身体性」をテーマの中心に据えて研究に取り組んでいます。"
    ]
  },
  ...
  workExperience: [
    ...
    },
    {
      ...
      desc:
        "[公共] [ビジネス] [情報] 領域を体系的に学びつつ、ゼミ選択を期に情報コースを専攻。石橋研究室に在籍。<br>“人とコンピュータとの相互作用”をテーマに研究に取り組む。高校教員免許（情報）の免許を取得。"
    },
    {
