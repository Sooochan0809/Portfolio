export const data = {
  profile: {
    ...
    bio: [
      ...
      "在籍していた研究室での活動を通して「人とテクノロジーの関係性」に興味を持ち、現在は「デジタル社会における身体性」をテーマの中心に据えて研究に取り組んでいます。"
    ]
  },
  ...
  workExperience: [
    {
      ...
      desc: "「目を使って映像の中のオブジェクトを操作する体験」をワークショップとして展開しています。"
    },
    {
      period: "2020/04 - 2024/03",
      title: "熊本県立大学　総合管理学部 総合管理学科",
      desc:
        `[公共] [ビジネス] [情報] 領域を体系的に学びつつ、ゼミ選択を期に情報コースを専攻。<a href="https://www.pu-kumamoto.ac.jp/users_site/kishibashi/lab/" target="_blank" rel="noopener">石橋研究室🔗</a>に在籍。<br>“人とコンピュータとの相互作用”をテーマに研究に取り組む。高校教員免許（情報）の免許を取得。`
    },
    {
      period: "2017/04 - 2020/03",
      title: "熊本中央高等学校　普通科",
      desc:
        "地元を離れ、県内有数のバドミントン部強豪校に進学。3年間、寮生活を送る。<br>最後の高校総体にて団体戦レギュラー入り、県内3位入賞を果たす。"
    }
  ],
